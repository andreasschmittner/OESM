! source file: /data2/aschmitt/models/OESM/0.1/oesm_11_t020_short/uvic/updates/atm.h
!======================== include file "atm.h" =========================
...
!     disch_unmskd= unmasked discharge from continents (g cm-2 s-1)
!     disch_runliq= discharge from ice sheet liquid runoff (g cm-2 s-1)
!     globaldisch_unmskd = global unmasked discharge (g s-1)
...
!   mtrack        = maximum size for tracking arrays
      ...
      real globaldisch, disch_unmskd, globaldisch_unmskd
      real disch_runliq, globaldisch_runliq
      ...
      common /embm_r/ disch_unmskd(imt,jmt), globaldisch_unmskd
      common /embm_r/ disch_runliq(imt,jmt), globaldisch_runliq
...
!     ta_disch_unmskd = time averaged unmasked discharge
!     ta_disch_runliq = time averaged discharge from ice sheet liqid runoff
...
!     ta_sulph      = time averaged sulph
      ...
      real ta_disch_unmskd, ta_disch_runliq
      ...
      common /embm_r/ ta_ws(imt,jmt), ta_disch_unmskd(imt,jmt)
      common /embm_r/ ta_disch_runliq(imt,jmt)
