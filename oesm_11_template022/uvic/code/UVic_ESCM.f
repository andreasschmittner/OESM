! source file: /data2/aschmitt/models/OESM/0.1/oesm_11_t020_short/uvic/updates/UVic_ESCM.F
...
!-----------------------------------------------------------------------
      ...
      trsbcindex(itemp) = isst
      call set (isss, m, mapsbc(m), 'sss', m)
      trsbcindex(isalt) = isss
