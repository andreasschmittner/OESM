! source file: /data2/aschmitt/models/OESM/0.1/oesm_11_template022/uvic/updates/embmio.F
...
!       convert emissions from g cm-2 to kg s-1
     ...
     &,                    tai_ssdfe
     &,                    tai_sssil
     &,                    tai_disch, tai_disch_unmskd, tai_disch_runliq
     &                     )
...
!             convert from kg/m2/s to g/cm2/s (converted back later)
     ...
     &,   ta_ws, ta_runoff, ta_disch_unmskd, ta_disch_runliq
     &,   sm, st
...
!       accumulate
     ...
     &                   *pass - dnswr(:,:))*scatter
        ...
        ta_disch_unmskd(:,:) = ta_disch_unmskd(:,:) + disch_unmskd(:,:)
        ta_disch_runliq(:,:) = ta_disch_runliq(:,:) + disch_runliq(:,:)
...
!       average
        ...
        ta_disch_unmskd(:,:) = ta_disch_unmskd(:,:)*rntatsa
        ta_disch_runliq(:,:) = ta_disch_runliq(:,:)*rntatsa
...
!-----------------------------------------------------------------------
        ...
        call areaavg (disch, dmsk, tmp)
        tai_disch = tai_disch + tmp
        call areaavg (disch_unmskd, dmsk, tmp)
        tai_disch_unmskd = tai_disch_unmskd + tmp
        call areaavg (disch_runliq, dmsk, tmp)
        tai_disch_runliq = tai_disch_runliq + tmp
...
!       average
        ...
        tai_disch = tai_disch*rntatia
        tai_disch_unmskd = tai_disch_unmskd*rntatia
        tai_disch_runliq = tai_disch_runliq*rntatia
