! source file: /data2/aschmitt/models/OESM/0.1/oesm_11_t020_short/uvic/updates/embm_tsi.F
...
!-----------------------------------------------------------------------
     ...
     &,   ' ', 'F', 'SH sea ice area', ' ', 'm2')
      call defvar ('F_disch', iou, 1, id, -c100, c100, ' '
     &,   'F', 'River discharge', ' ', 'kg m-2 s-1')
      call defvar ('F_disch_unmskd', iou, 1, id, -c100, c100, ' '
     &,   'F', 'River discharge unmasked', ' ', 'kg m-2 s-1')
      call defvar ('F_disch_runliq', iou, 1, id, -c100, c100, ' '
     &,   'F', 'River discharge from ice sheet liquid runoff', ' '
     &, 'kg m-2 s-1')
...
!-----------------------------------------------------------------------
     ...
     &,                        sssil
     &,                        disch, disch_unmskd, disch_runliq
     &                         )
!=======================================================================
!     output routine for atmospheric time step integrals
...
!=======================================================================
      ...
      real ssdfe, sssil, disch, disch_unmskd, disch_runliq
...
!-----------------------------------------------------------------------
      ...
      call putvars ('F_disch', iou, ntrec, disch, p1, c0)
      call putvars ('F_disch_unmskd', iou, ntrec, disch_unmskd, p1, c0)
      call putvars ('F_disch_runliq', iou, ntrec, disch_runliq, p1, c0)
